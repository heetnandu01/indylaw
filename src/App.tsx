...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF9F6] text-[#111827] flex flex-col justify-between selection:bg-[#D4AF37]/35 selection:text-[#0B132B]">
      {/* Sticky Navigation header */}
      <Navbar onBookDemoClick={handleOpenDemo} />

      {/* Hero Marketing Section */}
      <Hero onBookDemoClick={handleOpenDemo} onWatchTourClick={handleScrollToDemoShowcase} />
      ...
      {/* Alternating Features Section with Embedded Interactive Mockups */}
      <FeatureShowcase />
      ...
      {/* Security Credentials & Accordion FAQs */}
      <SecurityFAQ />
