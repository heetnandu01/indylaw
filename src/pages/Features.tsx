  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen text-[#111827] font-sans selection:bg-[#D4AF37]/30 selection:text-[#0B132B]">
      ...
      <section className="relative pt-32 pb-16 px-6 overflow-hidden bg-[#0B132B] text-white border-b border-[#D4AF37]/20">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-4 relative z-10">
          ...
          <h1 className="text-4xl sm:text-5xl font-serif font-bold text-white tracking-tight">
            Powerful Legal AI Features for Modern Practice
          </h1>
          <p className="text-xs sm:text-sm text-[#FAF9F6]/80 max-w-lg mx-auto">
            Comprehensive suite of AI research, drafting, case tracking, and workspace collaboration tools tailored for Indian litigation.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 px-6 space-y-36 max-w-7xl mx-auto">
        ...
        {/* FEATURE 1: AI Legal Research (Text Left, Image Right) */}
        <div id="ai-legal-research" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 space-y-6 lg:order-1">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#D4AF37]/10 border border-[#D4AF37]/20 rounded-full text-xs font-bold text-[#AA820A] uppercase tracking-wider">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {[
                ...
                <div key={item} className="flex items-center gap-2 text-xs sm:text-sm font-semibold text-[#0B132B]">
          ...
          <div className="lg:col-span-7 bg-white border border-[#0B132B]/10 rounded-2xl p-1.5 sm:p-2 shadow-xl hover:shadow-2xl transition-all duration-300 lg:order-2">
            <ResearchAI />
          </div>
        </div>
        ...
        {/* FEATURE 2: Project-Based Research (Image Left, Text Right) */}
        <div id="project-based-research" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 space-y-6 lg:order-2">
            <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-[#0B132B]/5 border border-[#0B132B]/10 rounded-full text-xs font-bold text-[#0B132B] uppercase tracking-wider">
            ...
            <div className="space-y-3 pt-2">
              {[
                ...
                <div key={item.label} className="flex gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#D4AF37]/15 flex items-center justify-center text-[#AA820A] mt-0.5 flex-shrink-0">
                    <Check className="w-3 h-3" />
                  </div>
                  <div>
                    <h4 className="text-xs sm:text-sm font-bold text-[#0B132B]">{item.label}</h4>
              ...
              <div className="flex flex-wrap items-center gap-2">
                {['Create Project', 'Add CNR', 'Fetch Case Data', 'Start Research'].map((step, idx) => (
                  <React.Fragment key={step}>
                    <div className="bg-[#0B132B] text-[#FAF9F6] text-[10px] font-bold px-3 py-1.5 rounded-lg border border-[#D4AF37]/20 shadow-sm">
                      {step}
                    </div>
          ...
          <div className="lg:col-span-7 bg-white border border-[#0B132B]/10 rounded-2xl p-1.5 sm:p-2 shadow-xl hover:shadow-2xl transition-all duration-300 lg:order-1">
            <Projects />
          </div>
        </div>
        ...
        {/* FEATURE 3: Context-Aware AI Research (Text Left, Image Right) */}
        <div id="context-aware-research" className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-5 space-y-6 lg:order-1">
            ...
            <div className="bg-[#0B132B] text-white p-5 rounded-2xl border border-[#D4AF37]/20 space-y-3 font-mono shadow-md">
              <div className="text-[10px] text-[#D4AF37] uppercase font-bold tracking-wider border-b border-white/10 pb-2">
                Reference cases easily
              </div>
              <p className="text-xs text-white/95 leading-relaxed">
                Users can reference projects in search queries using:
              </p>
              <div className="bg-white/10 border border-white/15 px-3 py-2 rounded-lg text-xs font-bold text-[#D4AF37] inline-block">
                @ProjectName
              </div>
              <div className="text-[10px] text-white/60 pt-1">
                Example search query:
              </div>
              <div className="bg-white/5 border border-white/10 px-3 py-2 rounded-lg text-xs italic text-white/90">
                "Find precedents relevant to @ABC_vs_XYZ"
              </div>
              <p className="text-[11px] text-[#FAF9F6]/70 italic pt-1">
        ...
        {/* FEATURE 4: Notes & Highlights (Image Left, Text Right) */}
          ...
          <div className="lg:col-span-5 space-y-6 lg:order-2">
            ...
            <div className="grid grid-cols-1 gap-3 pt-2">
              {[
                ...
                <div key={item} className="flex gap-3 text-xs sm:text-sm font-semibold text-[#0B132B]">
        ...
        {/* FEATURE 5: AI Drafting (Text Left, Image Right) */}
            ...
            <div className="pt-4 border-t border-[#0B132B]/10">
              ...
              <div className="flex flex-wrap items-center gap-2">
                {['Select Project', 'Add Notes', 'Reference @Project', 'Generate Draft'].map((step, idx) => (
                  <React.Fragment key={step}>
                    <div className="bg-white text-[#0B132B] text-[10px] font-bold px-3 py-1.5 rounded-lg border border-[#0B132B]/10 shadow-sm">
                      {step}
                    </div>
                    {idx < 3 && <ArrowRight className="w-3.5 h-3.5 text-[#D4AF37]" />}
                  </React.Fragment>
        ...
        {/* FEATURE 6: Legal Case Discovery (Image Left, Text Right) */}
        ...
        {/* FEATURE 7: Custom RAG Workspaces (Text Left, Image Right) */}
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['Judgments', 'Contracts & Agreements', 'Case Evidence', 'Internal Documents'].map((up) => (
                    <span key={up} className="bg-white border border-[#0B132B]/10 px-3 py-1.5 rounded-lg text-xs font-bold text-[#0B132B] shadow-sm">
                      {up}
                    </span>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['Private Knowledge Bases', 'Matter-Specific AI', 'Team Research Repositories'].map((cr) => (
                    <span key={cr} className="bg-[#0B132B] text-white px-3 py-1.5 rounded-lg text-xs font-bold shadow-sm">
                      {cr}
                    </span>
                  ))}
                </div>
        ...
        {/* FEATURE 8: Team Collaboration (Image Left, Text Right) */}
